                ...
                <div className="modfdfsdafasal-content" style={{zIndex: 9879789789789}}>
                    <div className="modal-content model-content-fooo popup__post">
                        <div className="closepopupicon" onClick={props.ChangePopup}>
                            <svg aria-label="Закрыть" className="closepopup" color="#ffffff" fill="#ffffff" height="18"
                        ...
                        <div className="post__options__wrap">
                            <div className="owner__post">
                                ...
                                <svg aria-label="Дополнительно" color="#fafafa" fill="#fafafa" height="24" role="img"
                            ...
                            <div className="post__likes__and__saves__wrap">
                                <div className="post__likes__and__saves">
                                    <div className="post__like__com__send">
                                        <div className="icon__with__padding">
                                            <svg aria-label="Нравится" color="#fafafa" fill="#fafafa" height="24"
                                        ...
                                        <div className="icon__with__padding">
                                            <svg aria-label="Комментировать" className="_ab6-" color="#fafafa"
                                        ...
                                        <div className="icon__with__padding">
                                            <svg aria-label="Поделиться публикацией" className="_ab6-" color="#fafafa"
                                                 fill="#fafafa" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    ...
                                    <div className="icon__with__padding">
                                        <svg aria-label="Сохранить" className="_ab6-" color="#fafafa" fill="#fafafa"
                                ...
                                <div className="how__many__user__licked__this__post">
                                    <p><b>{post.how__many__licked}</b> отметок "Нравится"</p>
