...
function Popup(props) {
    ...
    function fo(e){
        ...
        props.ChangeFolllowersPopup(URL.createObjectURL(file))
                    ...
                    <div className="modal-content model-content-fooo popup__cretePubs">
                        <div className="following__wrapper">
                            ...
                            <div className="upload__content">
                                <div className="upload__content__wrapp">
                                    <svg
                                        aria-label="Значок, соответствующий медиафайлам, например изображениям или видео"
                                        className="_ab6-" color="#fafafa" fill="#fafafa" height="77" role="img"
                                    ...
                                    <input hidden id="uploadfile" onChange={(e)=>fo(e)} name="uploadfile" type="file"/>
                                    <img width="0px" height="0px" id="blah" src="" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
